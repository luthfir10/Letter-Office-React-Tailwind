...
const Memorandum = () => {
  ...
  const [ccEkternal, setccEkternal] = useState([]);
  const handleSubmit = () => {
    console.log(AddressEkternal);
    console.log(ccEkternal);
  };
  return (
          ...
          <div className="grid gap-4 mb-6 lg:grid-cols-3">
            ...
            <div className="col-span-2">
              <TextAreaList
                ...
                arrays={AddressEkternal}
                setArrays={setAddressEkternal}
                required
              />
            </div>
          </div>
